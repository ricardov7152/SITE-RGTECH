      ...
      <nav className="fixed top-0 left-0 w-full px-4 md:px-8 py-2 bg-[#0D0D0D]/90 backdrop-blur-xl border-b border-white/10 shadow-[0_0_15px_rgba(59,130,246,0.1)] z-50">
        <div className="flex justify-between items-center h-full">
          ...
          <div className="hidden md:flex gap-8 items-center justify-center">
            <a className="text-slate-400 font-medium tracking-tight hover:text-blue-400 transition-colors duration-300 uppercase text-sm" href="#servicos">SERVIÇOS</a>
          ...
          <div className="flex gap-3 md:gap-4 items-center shrink-0">
            ...
            <Link to="/login" className="px-4 py-2 border border-white/10 hover:border-white/30 text-white font-bold rounded-lg hover:bg-white/5 transition-all text-xs md:text-sm whitespace-nowrap">
              LOGIN
            </Link>
        ...
        {isMenuOpen && (
          <div className="md:hidden absolute top-full left-0 w-full bg-[#0D0D0D] border-b border-white/10 py-4 px-6 flex flex-col gap-4 shadow-xl">
            <a className="text-slate-400 hover:text-white font-medium uppercase text-sm" href="#servicos" onClick={() => setIsMenuOpen(false)}>SERVIÇOS</a>
            ...
            <Link className="text-slate-400 hover:text-white font-medium uppercase text-sm" to="/login" onClick={() => setIsMenuOpen(false)}>LOGIN</Link>
          </div>
        )}
      </nav>
